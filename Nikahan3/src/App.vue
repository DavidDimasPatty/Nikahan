...
export default {
  setup() {
    ...
    const weddingPhotoStyle =() => {
        return {
          backgroundImage: `url(${fotoGalleryCover.value})`,
...
.overlay-content {
  ...
  align-items: center;
  justify-content: end; /* This ensures content is at the bottom */
  padding-bottom: 20px;
}
...
<template>
  <div v-if="id!=null || visitor!=null ||tglNikah!=null">
    ...
    <div id="overlay" class="overlay" :style="weddingPhotoStyle()">
      <div
